...
'../types');var _ShimDependencies = require(
...
'../ShimDependencies');var _d3utils = require(
...
VariantTrack = (function (_React$Component) {_inherits(VariantTrack, _React$Component);
  ...
  function VariantTrack(props) {_classCallCheck(this, VariantTrack);
    ...
    function render() {
      return _ShimDependencies.React.createElement('canvas', { onClick: this.handleClick.bind(this) });} }, { key: 'componentDidMount', value: 
    ...
    function handleClick(reactEvent) {
      ...
      x = ev.offsetX, 
      y = ev.offsetY, 
      canvas = _ShimDependencies.ReactDOM.findDOMNode(this);
      ...
      {
        throw new TypeError("canvas is not an Element");}} }]);return VariantTrack;})(_ShimDependencies.React.Component);
