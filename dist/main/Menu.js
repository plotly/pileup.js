...
Menu = (function (_React$Component) {_inherits(Menu, _React$Component);function Menu() {_classCallCheck(this, Menu);_get(Object.getPrototypeOf(Menu.prototype), 'constructor', this).apply(this, arguments);}_createClass(Menu, [{ key: 'clickHandler', value: 
    ...
    function render() {var _this = this;
      ...
      if (this.props.header) {
        els.push(_ShimDependencies.React.createElement('div', { key: 'header', className: 'menu-header' }, this.props.header));}

      els = els.concat(this.props.items.map(function (item, i) {
        if (typeof item === 'string') {// would prefer "== '-'", see flow#1066
          return _ShimDependencies.React.createElement('div', { key: i, className: 'menu-separator' });} else 
        {
          var checkClass = 'check' + (item.checked ? ' checked' : '');
          return (
            _ShimDependencies.React.createElement('div', { key: i, className: 'menu-item', onClick: makeHandler(i) }, 
            _ShimDependencies.React.createElement('span', { className: checkClass }), 
            _ShimDependencies.React.createElement('span', { className: 'menu-item-label' }, item.label)));}}));
      ...
      return (
        _ShimDependencies.React.createElement('div', { className: 'menu' }, 
        els));} }]);return Menu;})(_ShimDependencies.React.Component);
